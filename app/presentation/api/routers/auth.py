...
@router.get("/status")
async def auth_status(auth_service: AuthService = Depends(get_auth_service)) -> Dict[str, Any]:
...
async def auth_logout(auth_service: AuthService = Depends(get_auth_service)) -> None:
