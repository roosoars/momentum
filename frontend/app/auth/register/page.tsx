  ...
  if (success) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 px-6">
        <div className="w-full max-w-md space-y-4 rounded-2xl border border-emerald-500/40 bg-emerald-500/10 p-8 text-center">
          <h2 className="text-xl font-semibold text-emerald-200">Conta criada!</h2>
